...
function coachNavigationMarkup(){
  const groups = [
    ...
    { label: 'Begleitung', links: [['coach-reflexion', 'Coach-Rückmeldung'], ['coach-feedback', 'Rückmeldung an die Coaches'], ['speicher', 'Arbeitsstand']] }
  ];
